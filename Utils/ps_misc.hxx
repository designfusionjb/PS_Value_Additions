...
namespace ps
{
...
#ifdef _TC_10
	bool get_preference(const char *pref_name, int *num_prefs, char ***prefs);
	bool get_preference(const char *pref_name, char **pref);
	bool get_preference(const char *pref_name, int *pref);
	bool get_preference(const char *pref_name, logical *pref);
#else
	...
	bool get_preference(const char *pref_name, TC_preference_search_scope_t scope, logical *pref);
#endif
}