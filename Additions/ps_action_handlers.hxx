...
//! Searches structures for children to discontinue
/*!
 *  \note See exernal documentation for handler usage in Teamcenter.
 */
int ps_discontinue_structure_ah(EPM_action_message_t msg);

//! Logs signoff tasks from workflow process to form and relates to process targets
/*!
 *  \note See exernal documentation for handler usage in Teamcenter.
 */
